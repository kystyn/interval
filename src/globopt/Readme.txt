...
Type  demo toolbox intlab  for many demos on particular matters. 
...
INTLAB supports
     ...
     - and a number of toolboxes for intervals, affine arithmetic, gradients, hessians, taylor,
         fl-type, pair-arithmetic, slopes, polynomials, multi-precision arithmetic and more.
...
Copyright (c) 1998 - 2018 Siegfried M. Rump
